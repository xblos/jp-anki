<script lang="ts">
	...
	import { confirmModal, errorModal, loadingModal, newDeckModal } from './modals'
...
<main>
	...
	<Modal classWindow="modal" closeButton={false} closeOnOuterClick={false} closeOnEsc={false} show={$confirmModal}/>
	<Modal classWindow="modal" closeButton={false} closeOnOuterClick={false} closeOnEsc={false} show={$loadingModal}/>
	<Modal classWindow="modal" closeButton={false} closeOnOuterClick={false} closeOnEsc={false} show={$newDeckModal}/>
